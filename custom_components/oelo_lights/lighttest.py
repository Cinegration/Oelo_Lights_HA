...
class OeloLight(LightEntity, RestoreEntity):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        if self._effect and self._effect in pattern_commands:
            ...
            pattern_command = pattern_commands[self._effect]
            url = f"http://{self._ip}/setPattern?{pattern_command}"
        else:
    ...
    async def async_turn_off(self, **kwargs):
        ...
        url = f"http://{self._ip}/setPattern?{pattern_commands['Christmas: The Grinch Stole Christmas']}"
